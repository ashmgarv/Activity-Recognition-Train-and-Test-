...
results_assignment2 = pd.DataFrame(results+results_nn+results_svm, columns=['user', 'algo', 'precision', 'recall', 'f1'])


# In[39]:


results_assignment2.to_csv("results_assignment2.csv", index=False)
